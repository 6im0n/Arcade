...
Arcade::Menu::Menu(std::string graphicLib)
{
    ...
    _selectButton = new Button("Select", std::vector<std::size_t>(2, 2), std::vector<std::size_t>(10, 10), '\0', "", BUTTON_SELECTED_PATH);

    _currentButton = _runButtons;
    _selectButton->setPos(_currentButton->getPos().at(0), _currentButton->getPos().at(1));
    _exit = false;

    _texts.push_back(std::make_shared<Text>("", std::vector<std::size_t>(2, 2), std::vector<std::size_t>(10, 10), ' '));
    _texts.at(0)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(0)->setFontPath(FONT_PATH);
    _texts.push_back(std::make_shared<Text>("", std::vector<std::size_t>(100, 2), std::vector<std::size_t>(10, 10), ' '));
    _texts.at(1)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(1)->setFontPath(FONT_PATH);
    _texts.at(1)->setPos(100, 2);
    _texts.push_back(std::make_shared<Text>("", std::vector<std::size_t>(100, 15), std::vector<std::size_t>(10, 10), ' '));
    _texts.at(2)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(2)->setFontPath(FONT_PATH);
    _texts.at(2)->setPos(100, 15);
    _texts.push_back(std::make_shared<Text>("Run", std::vector<std::size_t>(135, 90), std::vector<std::size_t>(50, 50), 'R'));
    _texts.at(3)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(3)->setFontPath(FONT_PATH);
    _texts.at(3)->setPos(135, 90);
    _texts.push_back(std::make_shared<Text>("Exit", std::vector<std::size_t>(890, 90), std::vector<std::size_t>(50, 50), 'E'));
    _texts.at(4)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(4)->setFontPath(FONT_PATH);
    _texts.at(4)->setPos(890, 90);
    _texts.push_back(std::make_shared<Text>("Player", std::vector<std::size_t>(1645, 90), std::vector<std::size_t>(50, 50), 'P'));
    _texts.at(5)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(5)->setFontPath(FONT_PATH);
    _texts.at(5)->setPos(1620, 90);
    _texts.push_back(std::make_shared<Text>(games.at(0).substr(games.at(0).find("_") + 1, games.at(0).substr(games.at(0).find("_") + 1).length() - 3), std::vector<std::size_t>(374, 440), std::vector<std::size_t>(50, 50), gamesLabel.at(0)));
    _texts.at(6)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(6)->setFontPath(FONT_PATH);
    _texts.at(6)->setPos(460, 440);
    _texts.push_back(std::make_shared<Text>(games.at(1).substr(games.at(1).find("_") + 1, games.at(1).substr(games.at(1).find("_") + 1).length() - 3), std::vector<std::size_t>(1022, 440), std::vector<std::size_t>(50, 50), gamesLabel.at(1)));
    _texts.at(7)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(7)->setFontPath(FONT_PATH);
    _texts.at(7)->setPos(1240, 440);
    _texts.push_back(std::make_shared<Text>(libs.at(0).substr(libs.at(0).find("_") + 1, libs.at(0).substr(libs.at(0).find("_") + 1).length() - 3), std::vector<std::size_t>(135, 790), std::vector<std::size_t>(50, 50), libsLabel.at(0)));
    _texts.at(8)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(8)->setFontPath(FONT_PATH);
    _texts.at(8)->setPos(125, 790);
    _texts.push_back(std::make_shared<Text>(libs.at(1).substr(libs.at(1).find("_") + 1, libs.at(1).substr(libs.at(1).find("_") + 1).length() - 3), std::vector<std::size_t>(890, 790), std::vector<std::size_t>(50, 50), libsLabel.at(1)));
    _texts.at(9)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(9)->setFontPath(FONT_PATH);
    _texts.at(9)->setPos(845, 790);
    _texts.push_back(std::make_shared<Text>(libs.at(2).substr(libs.at(2).find("_") + 1, libs.at(2).substr(libs.at(2).find("_") + 1).length() - 3), std::vector<std::size_t>(1645, 790), std::vector<std::size_t>(50, 50), libsLabel.at(2)));
    _texts.at(10)->setColor(std::make_unique<Color>(255, 255, 255, 255));
    _texts.at(10)->setFontPath(FONT_PATH);
    _texts.at(10)->setPos(1645, 790);
